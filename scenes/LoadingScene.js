...
export default class LoadingScene extends Scene {
  ...
  preload() {
    ...
    this.load.image("shop-menu", "../assets/shop-menu.png");
    this.load.image("open-shop-button", "../assets/open-shop-button.png");
    this.load.image("exit-button", "../assets/exit-button.png");
